...
import uk.gov.hmrc.lisaapi.models.{
  GetBulkPaymentNotFoundResponse, GetBulkPaymentServiceUnavailableResponse, GetBulkPaymentSuccessResponse
}
          ...
          withValidDates(startDate, endDate, lisaManager) { (start, end) =>
            ...
            response flatMap {
              case s: GetBulkPaymentSuccessResponse         =>
                logger.info(
                  s"""[BulkPaymentController][getBulkPayment] GetBulkPaymentSuccessResponse lisaManager : $lisaManager"""
                )
              ...
              case GetBulkPaymentNotFoundResponse           =>
                logger.info(
                  s"""[BulkPaymentController][getBulkPayment] GetBulkPaymentNotFoundResponse lisaManager : $lisaManager"""
                )
              ...
              case GetBulkPaymentServiceUnavailableResponse =>
                logger.error(
                  s"[BulkPaymentController][getBulkPayment] GetBulkPaymentServiceUnavailableResponse lisaManager : $lisaManager"
                )
