...
case class ErrorBadRequest(errs: List[ErrorValidation])
    extends ErrorResponseWithErrors(400, "BAD_REQUEST", "Bad Request", errors = Some(errs))

case class ErrorForbidden(errs: List[ErrorValidation])
    extends ErrorResponseWithErrors(403, "FORBIDDEN", "There is a problem with the request data", errors = Some(errs))
...
case object ErrorAcceptHeaderVersionInvalid
    extends ErrorResponse(406, "ACCEPT_HEADER_INVALID", "The accept header has an invalid version for this endpoint")

case object ErrorAcceptHeaderContentInvalid
    extends ErrorResponse(406, "ACCEPT_HEADER_INVALID", "The accept header has an invalid content type")
...
case object ErrorInvestorNotFound
    extends ErrorResponse(403, "INVESTOR_NOT_FOUND", "The investor details given do not match with HMRC’s records")

case object ErrorLifeEventIdNotFound
    extends ErrorResponse(404, "LIFE_EVENT_NOT_FOUND", "The lifeEventId does not match with HMRC’s records")

case object ErrorInvestorNotEligible
    extends ErrorResponse(403, "INVESTOR_ELIGIBILITY_CHECK_FAILED", "The investor is not eligible for a LISA account")

case object ErrorInvestorComplianceCheckFailedCreateTransfer
...
case object ErrorAccountCancellationPeriodExceeded
    extends ErrorResponse(
      403,
...
case object ErrorAccountWithinCancellationPeriod
    extends ErrorResponse(
      403,
...
case object ErrorPreviousAccountDoesNotExist
    extends ErrorResponse(
      403,
...
case object ErrorAccountAlreadyClosedOrVoid
    extends ErrorResponse(
      403,
      "INVESTOR_ACCOUNT_ALREADY_CLOSED_OR_VOID",
      "This LISA account has already been closed or been made void by HMRC"
    )

case object ErrorAccountAlreadyVoided
    extends ErrorResponse(403, "INVESTOR_ACCOUNT_ALREADY_VOID", "The LISA account is already void")

case object ErrorAccountAlreadyClosed
    extends ErrorResponse(403, "INVESTOR_ACCOUNT_ALREADY_CLOSED", "The LISA account is already closed")

case object ErrorAccountAlreadyCancelled
    extends ErrorResponse(403, "INVESTOR_ACCOUNT_ALREADY_CANCELLED", "The LISA account is already cancelled")

case object ErrorAccountAlreadyOpen
    extends ErrorResponse(
      403,
...
case object ErrorBulkTransactionNotFoundV1
    extends ErrorResponse(404, "PAYMENT_NOT_FOUND", "No bonus payments have been made for this date range")

case object ErrorBulkTransactionNotFoundV2
    extends ErrorResponse(404, "TRANSACTION_NOT_FOUND", "No payments or debts exist for this date range")

case object ErrorTransferAccountDataNotProvided
    extends ErrorResponse(
      403,
...
case object ErrorTransferAccountDataProvided
    extends ErrorResponse(
      403,
...
case object ErrorLifeEventInappropriate
    extends ErrorResponse(
      403,
...
case object ErrorInvalidLisaManager
    extends ErrorResponse(401, "UNAUTHORIZED", "Enter a real lisaManagerReferenceNumber")

case object ErrorBonusPaymentTransactionNotFound
    extends ErrorResponse(404, "BONUS_PAYMENT_TRANSACTION_NOT_FOUND", "transactionId does not match HMRC’s records")

case object ErrorTransactionNotFound
    extends ErrorResponse(404, "TRANSACTION_NOT_FOUND", "transactionId does not match HMRC’s records")

case object ErrorWithdrawalNotFound
    extends ErrorResponse(404, "WITHDRAWAL_CHARGE_TRANSACTION_NOT_FOUND", "transactionId does not match HMRC’s records")

case object ErrorBonusClaimError
    extends ErrorResponse(
      403,
      "BONUS_CLAIM_ERROR",
...
case object ErrorBonusSupersededAmountMismatch
    extends ErrorResponse(
      403,
...
case object ErrorBonusSupersededOutcomeError
    extends ErrorResponse(
      403,
...
case object ErrorBonusClaimTimescaleExceeded
    extends ErrorResponse(
      403,
...
case object ErrorBonusHelpToBuyNotApplicable
    extends ErrorResponse(
      403,
...
case object ErrorNoSubscriptions
    extends ErrorResponse(
      403,
...
case object ErrorWithdrawalReportingError
    extends ErrorResponse(
      403,
...
case object ErrorWithdrawalSupersededAmountMismatch
    extends ErrorResponse(
      403,
...
case object ErrorWithdrawalSupersededOutcomeError
    extends ErrorResponse(
      403,
...
case object ErrorWithdrawalTimescalesExceeded
    extends ErrorResponse(
      403,
...
case object ErrorCouldNotProcessWithdrawalRefund
    extends ErrorResponse(403, "COULD_NOT_PROCESS_WITHDRAWAL_CHARGE_REFUND", "Charge refund has been cancelled by HMRC")

case class ErrorLifeEventAlreadyExists(lifeEventId: String)
...
case object ErrorAccountNotOpenLongEnough
    extends ErrorResponse(
      403,
...
object ErrorWithdrawalAlreadySuperseded {
  ...
  def apply(transactionId: String): ErrorResponseWithTransactionId =
    ErrorResponseWithTransactionId(
      403,
...
object ErrorInvestorAlreadyExists {
  ...
  def apply(investorId: String): ErrorResponseWithId =
...
object ErrorAccountAlreadyExists {
  ...
  def apply(accountId: String): ErrorResponseWithAccountId =
    ErrorResponseWithAccountId(
      409,
...
case object ErrorLifeEventNotProvided
    extends ErrorResponse(
      403,
