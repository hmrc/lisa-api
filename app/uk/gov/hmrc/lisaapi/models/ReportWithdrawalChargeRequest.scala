...
object ReportWithdrawalChargeRequest {
  ...
  implicit val reportWithdrawalChargeReads: Reads[ReportWithdrawalChargeRequest] =
    Reads[ReportWithdrawalChargeRequest] { json =>
  ...
  implicit val reportWithdrawalChargeWrites: Writes[ReportWithdrawalChargeRequest] =
    Writes[ReportWithdrawalChargeRequest] {
