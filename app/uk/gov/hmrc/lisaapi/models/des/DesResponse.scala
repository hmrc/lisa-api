  ...
  implicit val desGetBonusPaymentResponse: Reads[DesGetBonusPaymentResponse] = (
    ...
    (
      ...
      DesGetBonusPaymentResponse(
        ...
        InboundPayments(newSubsInPeriod, newSubsYtd, totalSubsInPeriod, totalSubsYtd),
        Bonuses(
          bonusDueForPeriod,
          bonusDueYtd,
          bonusPaidYtd,
        ...
        (
          ...
          case (Some(transId), Some(transAmount), Some(transResult), Some(transReason)) =>
            transReason match {
              ...
              case "BONUS_RECOVERY"   =>
                Some(BonusRecovery(automaticRecoveryAmount.get, transId, transAmount, transResult))
            }
          case _                                                                        => None
        }
      )
