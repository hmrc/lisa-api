  ...
  def getBonusOrWithdrawal(lisaManager: String, accountId: String, transactionId: String)(implicit
    ...
    desConnector.getBonusOrWithdrawal(lisaManager, accountId, transactionId) map {
      case successResponse: GetBonusOrWithdrawalResponse =>
        logger.info(
          s"[BonusOrWithdrawalService][getBonusOrWithdrawal] Matched GetBonusOrWithdrawalResponse for lisaManager : $lisaManager"
        )
        successResponse
      case DesUnavailableResponse                        =>
        logger.warn(
          s"[BonusOrWithdrawalService][getBonusOrWithdrawal] Matched DesUnavailableResponse for lisaManager : $lisaManager"
        )
        GetBonusOrWithdrawalServiceUnavailableResponse
      case failureResponse: DesFailureResponse           =>
        logger.error(
          s"[BonusOrWithdrawalService][getBonusOrWithdrawal] Matched DesFailureResponse for lisaManager : $lisaManager and the code is : ${failureResponse.code}"
        )
        failureResponse.code match {
          ...
          case _                              =>
            logger.error(
              s"[BonusOrWithdrawalService][getBonusOrWithdrawal] Get bonus payment or withdrawal returned error: ${failureResponse.code} for lisaManager : $lisaManager"
            )
