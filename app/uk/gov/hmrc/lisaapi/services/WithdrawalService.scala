  ...
  def reportWithdrawalCharge(lisaManager: String, accountId: String, request: ReportWithdrawalChargeRequest)(implicit
    ...
    desConnector.reportWithdrawalCharge(lisaManager, accountId, request) map {
      case successResponse: DesTransactionResponse                                 =>
        logger.info(
          s"[WithdrawalService][reportWithdrawalCharge] Matched ReportWithdrawalChargeSuccessResponse and the message is : ${successResponse.message} for lisaManager: $lisaManager"
        )
        request match {
      ...
      case DesUnavailableResponse                                                  =>
        logger.warn(
          s"[WithdrawalService][reportWithdrawalCharge] Matched DesUnavailableResponse for lisaManager: $lisaManager"
        )
        ReportWithdrawalChargeServiceUnavailable
      case alreadyExistsResponse: DesWithdrawalChargeAlreadyExistsResponse         =>
        logger.warn(
          s"[WithdrawalService][reportWithdrawalCharge] Matched DesWithdrawalChargeAlreadyExistsResponse and the code is : ${alreadyExistsResponse.code} for lisaManager: $lisaManager"
        )
      ...
      case alreadySupersededResponse: DesWithdrawalChargeAlreadySupersededResponse =>
        logger.warn(
          s"[WithdrawalService][reportWithdrawalCharge] Matched DesWithdrawalChargeAlreadySupersededResponse and the code is: ${alreadySupersededResponse.code} for lisaManager: $lisaManager"
        )
        ReportWithdrawalChargeAlreadySuperseded(alreadySupersededResponse.supersededTransactionByID)
      case failureResponse: DesFailureResponse                                     =>
        logger.warn(
          s"[WithdrawalService][reportWithdrawalCharge] Matched DesFailureResponse and the code is :${failureResponse.code} for lisaManager: $lisaManager"
        )
        desFailures.getOrElse(
          failureResponse.code, {
            logger.error(
              s"[WithdrawalService][reportWithdrawalCharge] Request bonus payment returned error: ${failureResponse.code} for lisaManager: $lisaManager"
            )
