...
trait ControllerTestFixture
  ...
  val mockDesTransactionService: TransactionService         = mock[TransactionService]
  val mockHipTransactionService: HipTransactionService         = mock[HipTransactionService]
  val mockTransactionService: RoutingTransactionService        = mock[RoutingTransactionService]
