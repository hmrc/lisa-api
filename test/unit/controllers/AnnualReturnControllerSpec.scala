...
class AnnualReturnControllerSpec extends ControllerTestFixture {
  ...
  val annualReturnController: AnnualReturnController = new AnnualReturnController(
    mockAuthConnector,
    mockAppContext,
    mockLifeEventService,
    mockAuditService,
    mockAnnualReturnValidator,
    mockLisaMetrics,
  ...
  private def doRequest(
    ...
    val res = annualReturnController
      ...
      .apply(req.withHeaders(acceptHeader).withBody(AnyContentAsJson(payload)))
