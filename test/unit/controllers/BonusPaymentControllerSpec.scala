        ...
        doSyncRequest(validBonusPaymentJson) { res =>
          ...
          verify(mockAuditService).audit(
            ...
            auditData = MatcherEquals(Map(
              ...
              "htbTransferInForPeriod" -> (htb \ "htbTransferInForPeriod").as[BigDecimal].toString,
              "htbTransferTotalYTD" -> (htb \ "htbTransferTotalYTD").as[BigDecimal].toString,
              "newSubsForPeriod" -> (inboundPayments \ "newSubsForPeriod").as[BigDecimal].toString,
              "newSubsYTD" -> (inboundPayments \ "newSubsYTD").as[BigDecimal].toString,
              "totalSubsForPeriod" -> (inboundPayments \ "totalSubsForPeriod").as[BigDecimal].toString,
              "totalSubsYTD" -> (inboundPayments \ "totalSubsYTD").as[BigDecimal].toString,
              "bonusDueForPeriod" -> (bonuses \ "bonusDueForPeriod").as[BigDecimal].toString,
              "bonusPaidYTD" -> (bonuses \ "bonusPaidYTD").as[BigDecimal].toString,
              "totalBonusDueYTD" -> (bonuses \ "totalBonusDueYTD").as[BigDecimal].toString,
