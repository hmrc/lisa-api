...
class BonusPaymentControllerSpec extends PlaySpec
  ...
  val SUT = new BonusPaymentController(mockAuthCon, mockAppContext, mockGetService, mockPostService, mockAuditService, mockValidator, mockDateTimeService, mockLisaMetrics, mockControllerComponents) {
