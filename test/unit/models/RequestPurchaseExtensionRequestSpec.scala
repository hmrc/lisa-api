...
class RequestPurchaseExtensionRequestSpec extends PlaySpec {
  ...
  "RequestSupersededPurchaseExtension" must {
    ...
    "deserialize to json" in {
      ...
      val expected =
        """{"eventType":"Extension one","eventDate":"2017-05-10","supersededLifeEventDate":"2017-05-10","supersededLifeEventID":"6789000001"}"""
    ...
    "validate the event type" in {
      ...
      val json =
        """{"eventDate":"2017-05-11","eventType":"Extension 1","supersede":{"originalEventDate":"2017-05-10","originalLifeEventId":"6789000001"}}"""
    ...
    "validate the event date" in {
      ...
      val json =
        """{"eventDate":"3000-05-11","eventType":"Extension one","supersede":{"originalEventDate":"2017-05-10","originalLifeEventId":"6789000001"}}"""
    ...
    "validate the supersede object" in {
      ...
      res match {
        case JsError(errors) =>
          ...
          errors must contain(
            (JsPath \ "supersede" \ "originalEventDate", Seq(JsonValidationError("error.path.missing")))
          )
          errors must contain(
            (JsPath \ "supersede" \ "originalLifeEventId", Seq(JsonValidationError("error.path.missing")))
          )
        case _               => fail("Parsed invalid json as being valid")
      }
    ...
    "validate the originalEventDate" in {
      ...
      val json =
        """{"eventDate":"2017-05-11","eventType":"Extension one","supersede":{"originalEventDate":"3000-05-10","originalLifeEventId":"6789000001"}}"""
      ...
      res match {
        case JsError(errors) =>
          errors mustBe Seq(
            (JsPath \ "supersede" \ "originalEventDate", Seq(JsonValidationError("error.formatting.date")))
          )
        case _               => fail("Parsed invalid json as being valid")
      }
    ...
    "validate the originalLifeEventId" in {
      ...
      val json =
        """{"eventDate":"2017-05-11","eventType":"Extension one","supersede":{"originalEventDate":"2017-05-10","originalLifeEventId":"one"}}"""
      ...
      res match {
        case JsError(errors) =>
          errors mustBe Seq(
            (JsPath \ "supersede" \ "originalLifeEventId", Seq(JsonValidationError("error.formatting.lifeEventId")))
          )
        case _               => fail("Parsed invalid json as being valid")
      }
